...
const SimpleBookingPaymentForm = ({ trip, onSuccess, onCancel }) => {
...
const SimpleBookingPayment = ({ trip, onSuccess, onCancel }) => {
  return (
    <Elements stripe={stripePromise}>
      <SimpleBookingPaymentForm 
        trip={trip} 
        onSuccess={onSuccess} 
        onCancel={onCancel} 
      />
...
export default SimpleBookingPayment;
